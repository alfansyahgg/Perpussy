...
<head>
  ...
  <title>Sistem Perpus Login</title>
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              ...
              <img src="<?php echo base_url('assets/images/books-2.png'); ?>" style="width: 100%;height: auto;margin-top: 120px;">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="<?php echo base_url('C_Index/login'); ?>">
